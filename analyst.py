...
def generate_response(messages, api_key=None):
    ...
    try:
        ...
        return f"Error en la comunicación con Groq: {str(e)}"
...
Analiza el mensaje del usuario. Identifica un término disonante o simbólico. No respondas al contenido general, solo pregunta por ese término específico."""
    ...
    return generate_response(messages, api_key)
...
Considera este mensaje (P2) and el anterior (P1). ¿Cómo cambia el sentido de P1 a la luz de P2? Formula una pregunta que cuestione la lógica de este bloque conjunto."""
